...
class PangoCairoTextRenderer(TextRenderingMixin):
    ...
    def _render_words_to_surface(self, words: List[str], **kwargs) -> Encoding:
        ...
        for word in words[:-1]:
            ...
            word_start_indices.append(math.ceil(offset / self.pixels_per_patch) + 1)
        ...
        encoding = Encoding(
            symb_values=self.get_image_from_surface(surface, sep_patches=sep_patches),
